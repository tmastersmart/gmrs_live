...
if ($u[1] ==""){ //slide over data to fix corruped entries
    $u[1]=$u[2];
    if($u[3]!=""){// Slide the next line
      $u[2]=$u[3];
      $u[3]="";
    }
}

 //  Corrupted data fix.   TBR when fixed
if ($u[0]==1255){$u[1]="Carl"; $u[2]="San Antonio, TX USA"; $u[3]="[WRFH397]";$u[4]="N"; }
