...
<SCRIPT>
    function OpenActiveNodes () {
        window.open('gmrs-list.php');
    }
    function OpenAllNodes () {
        window.open('gmrs-rep.php');
    }
    function OpenHubs () {
    window.open('gmrs-hubs.php');
    }
    function OpenHelp () {
...
<input type="button" class="submit" value="All Nodes" OnClick="OpenActiveNodes()">
<input style="margin-bottom:1px;" type="button" class="submit" value="All Repeaters" OnClick="OpenAllNodes()">
<input style="margin-bottom:1px;" type="button" class="submit" value="All Hubs" OnClick="OpenHubs()">
<?php
// ADDED KN2R 6-2018
